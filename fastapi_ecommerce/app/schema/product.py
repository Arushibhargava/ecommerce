...
class Dimensions_cm(BaseModel):
    length:Annotated[float,Field(gt=0,strict=True,description="Enter length in cm")]
    width:Annotated[float,Field(gt=0,strict=True,description="Enter width in cm")]
    height:Annotated[float,Field(gt=0,strict=True,description="Enter height in cm")]
...
class Product(BaseModel):
    ...
    def volume(self)->float:
        ...
        return round(d.height*d.width*d.length,2)
